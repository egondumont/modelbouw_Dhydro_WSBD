...
class ProcessCulverts:
    ...
    def run(self):
        ...
        profile_data = gpd.read_file(self.output_dir /"profielpunt.gpkg")
        network_data = gpd.read_file(self.output_dir / 'hydroobject.gpkg')
        network_sindex = network_data.sindex
        raw_data = gpd.read_file(self.source_data_dir / "duikersifonhevel.gpkg")
        ...
        raw_data.to_file(self.output_dir /'duikersifonhevel.gpkg', driver='GPKG') 
