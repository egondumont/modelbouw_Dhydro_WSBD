...
class Gml:
    ...
    def _generate(self):
        ...
        Box = etree.SubElement(boundedBy, self.GML + "Box", srsName=str(self.crs))
        ...
        for index, row in self.gdf.iterrows():
            ...
            if 'geometry' in self.gdf.columns:
                if row['geometry'].geom_type == "LineString":
                    ...
                    lineString = etree.SubElement(lineStringProp, self.GML + "LineString", srsName=str(self.crs))
                ...
                if row['geometry'].geom_type == "Point":
                    ...
                    point = etree.SubElement(pointProp, self.GML + "Point", srsName=str(self.crs))
                ...
                if row['geometry'].geom_type == "MultiPolygon":
                    ...
                    if len(row['geometry'].geoms) == 1:
                        ...
                        polygon = etree.SubElement(polygonProp, self.GML + "Polygon", srsName=str(self.crs))
    ...
    def validate(self, write_error_log=True):
    ...
    def _assertvalid(self, write_error_log=True):
